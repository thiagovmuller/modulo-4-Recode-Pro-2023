...
<title>TVM | Cadastrar Compra</title>
</head>
<body>
	<main>
		...
		<div class="container py-3">
            <form action="compra-cadastrar">
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="text" id="idCliente" name="idCliente" class="form-control" value="" />
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="text" id="idPassagem" name="idPassagem" class="form-control" value="" />
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="text" id="formaPgto" name="formaPgto" class="form-control" value="" />
	            </div>
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="number" id="valorTotal" name="valorTotal" class="form-control" value="" />
	            </div>
