...
<body>
	<main>
		...
		<section class="container">
			...
			<div class="p-4">
				<a href="compra-get-cadastrar"
					class="btn btn-primary mb-2 botao1"> Nova Compra </a>
					...
					<tbody>
						...
						<jstl:forEach items="${listaCompras}" var="c">
							<tr>
								...
								<td>
									<div class="d-flex">
										<a href="compra-consultar-id?id=${c.idCompra}" class="mx-1" title="Editar">
											<i class="ri-file-edit-line"></i>
										</a> 
										<a href="compra-deletar?id=${c.idCompra}" class="mx-1" title="Deletar"
											onclick="return confirm('Deseja excluir a compra ${c.idCompra}?')">
