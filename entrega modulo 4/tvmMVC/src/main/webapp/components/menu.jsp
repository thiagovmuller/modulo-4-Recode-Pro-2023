...
<div class="container">
	<div class="topnav responsive nav-container" id="myTopnav">
		...
		<a class="nav-link" href="<%=request.getParameter("destinos")%>">Destinos</a>
		<a class="nav-link" href="<%=request.getParameter("promocoes")%>">Promoções</a>
		<a class="nav-link" href="<%=request.getParameter("contato")%>">Contato</a>
		<a class="nav-link" href="<%=request.getParameter("clientes")%>">Clientes</a>
		<a class="nav-link" href="<%=request.getParameter("compras")%>">Compras</a>
